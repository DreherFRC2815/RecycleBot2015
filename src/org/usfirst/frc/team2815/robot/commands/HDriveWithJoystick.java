 ...
 * robot using the arcade drive type with h-drive wheel addition and a joystick.The execute method calls the drive type
...
public class HDriveWithJoystick extends Command {
    ...
    protected void execute() {
    	...
    	Robot.driveTrain.setDriveSpeed(Robot.oi.getBoost(),Robot.oi.getSlow());
